...
1. 在[思源笔记工作空间](https://github.com/siyuan-note/siyuan)的 `data/plugins/` 目录下创建文件夹 `siyuan-plugin-concat-subdocs`。
...
在集市中搜索`siyuan-plugin-concat-subdocs`、`子文档拼接`等关键字一键安装。
...
<img src="https://github.com/yifengjob/siyuan-plugin-concat-subdocs/raw/main/wechat-reward.png"  onerror="this.onerror=null;this.src='./wechat-reward.png';" alt="微信赞赏码" width="300" align="center" style="height: auto;box-shadow: 0px 0px 5px #aaaaaa;">
